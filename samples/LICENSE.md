# Licenses for all samples
The large text samples in this folder come from [Project Gutenberg](https://www.gutenberg.org/). The text files are public domain.


In order to not skew results, the samples do not contain license text. 

The following license applies to each book in this folder:
